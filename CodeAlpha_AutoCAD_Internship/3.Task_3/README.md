# Task 3 — 3D Modeling: Mechanical Part

## Brief
Create a 3D model of a mechanical part, civil/architectural structure, or room model. Apply materials, lighting, and rendering for presentation. Submit the 3D file + rendered image.

## Part Description
**Single-ended open-end wrench**

A flat-shank wrench with an angled open jaw at one end, sized to grip a hex or square fastener head from the side rather than surrounding it (as a box/ring wrench would).
...
- Angled open jaw (~15° offset typical of standard open-end wrenches) sized for a single fastener width.
